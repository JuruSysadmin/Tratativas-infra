(() => {
  ...
  var EntryUploader = class {
    ...
    readNextChunk() {
      ...
      reader.onload = (e) => {
        var _a2, _b;
        if (((_a2 = e.target) == null ? void 0 : _a2.error) === null) {
...
`
  ...
  var DOMPatch = class {
    constructor(view, container, html, streams, targetCID, opts = {}) {
      ...
      this.undoRef = (_a2 = opts.undoRef) != null ? _a2 : null;
    }
          ...
          onBeforeNodeDiscarded: (el) => {
            ...
            if (dom_default.isPortalTemplate(el)) {
              const teleportedEl = document.getElementById(
                ((_a2 = el.content.firstElementChild) == null ? void 0 : _a2.id) || ""
              );
              if (teleportedEl) {
                teleportedEl.remove();
    ...
    handleRuntimeHook(el, source) {
      ...
      if (el.hasAttribute("nonce")) {
        ...
        nonce = (_b = (_a2 = template.content.querySelector(`script[${PHX_RUNTIME_HOOK}="${CSS.escape(name)}"]`)) == null ? void 0 : _a2.getAttribute("nonce")) != null ? _b : null;
      }
  ...
  var View = class _View {
    ...
    constructor(el, liveSocket2, parentView, flash = null, liveReferer = null) {
      ...
      this.channel = this.liveSocket.channel(`lv:${this.id}`, () => {
        ...
        return {
          ...
          flash: (_a2 = this.flash) != null ? _a2 : void 0,
    ...
    maybeRecoverForms(html, callback) {
      ...
      dom_default.all(template.content, `[${PHX_PORTAL}]`).forEach((portalTemplate) => {
        ...
        (_a3 = template.content.firstElementChild) == null ? void 0 : _a3.appendChild(
      ...
      rootEl.setAttribute(PHX_STATIC, (_a2 = this.getStatic()) != null ? _a2 : "");
    ...
    getDescendentByEl(el) {
      ...
      if (el.id === this.id) {
        ...
        return this.children && ((_a2 = this.children[el.getAttribute(PHX_PARENT_ID)]) == null ? void 0 : _a2[el.id]);
      }
    }
